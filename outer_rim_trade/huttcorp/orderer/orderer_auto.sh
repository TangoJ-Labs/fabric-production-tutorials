...
fabric-ca-client enroll -d -u https://huttcorp-orderer:ordererpw@huttcorp-ca:7054 -M $ORDERER_GENERAL_LOCALMSPDIR
...
/shared/utils/msp_add_admincert.sh -c /shared/huttcorp-admin@huttcorp-cert.pem -m $ORDERER_GENERAL_LOCALMSPDIR #MSP CORRECTION
...
# Start the orderer
echo "Starting orderer 'huttcorp-orderer' with MSP at '$ORDERER_GENERAL_LOCALMSPDIR'"
orderer