...
if [ "$CERT" = "" ] || [ "$MSPDIR" = "" ]; then
    ...
    cp $CERT $MSPDIR/admincerts/cloudcityinc-admin@cloudcityinc-cert.pem #MSP CORRECTION
    cp $CERT $MSPDIR/admincerts/cloudcityinc-admin@cloudcityincMSP-cert.pem #MSP CORRECTION
fi
