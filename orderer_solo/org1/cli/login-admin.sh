...
export FABRIC_CA_CLIENT_HOME=$FABRIC_CFG_PATH/orgs/org1/users/org1-admin #MSP CORRECTION
...
if [ ! -d $FABRIC_CA_CLIENT_HOME ]; then
    ...
    cp $FABRIC_CA_CLIENT_HOME/msp/signcerts/cert.pem $FABRIC_CA_CLIENT_HOME/msp/signcerts/org1-admin@org1-cert.pem #MSP CORRECTION
    # For certfileuserstore (github.com/hyperledger/fabric-sdk-go/pkg/msp/certfileuserstore.go):
    cp $FABRIC_CA_CLIENT_HOME/msp/signcerts/cert.pem $FABRIC_CA_CLIENT_HOME/msp/signcerts/org1-admin@org1MSP-cert.pem #MSP CORRECTION
    ...
    cp $FABRIC_CA_CLIENT_HOME/msp/signcerts/org1-admin@org1-cert.pem /shared/org1-admin@org1-cert.pem #MSP CORRECTION
fi
