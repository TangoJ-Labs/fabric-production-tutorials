...
export FABRIC_CA_CLIENT_HOME=/data/orgs/org2/admin
export FABRIC_CA_CLIENT_TLS_CERTFILES=/data/org2-ca-cert.pem

if [ ! -d /data/orgs/org2/admin ]; then
    ...
    mkdir -p /data/orgs/org2/admin/msp/admincerts
    cp /data/orgs/org2/admin/msp/signcerts/cert.pem /data/orgs/org2/admin/msp/admincerts/cert.pem

    # Copy the admin cert to the msp dir
    mkdir -p /data/orgs/org2/msp/admincerts
    cp /data/orgs/org2/admin/msp/signcerts/cert.pem /data/orgs/org2/msp/admincerts/cert.pem
