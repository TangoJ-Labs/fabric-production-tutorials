...
if [ ! -d $FABRIC_CA_CLIENT_HOME ]; then
    ...
    # # Copy the public admin cert to the admin dir
    # mkdir -p $FABRIC_CFG_PATH/orgs/org1/msp/user/org1-admin/msp/admincerts
    # cp $FABRIC_CFG_PATH/orgs/org1/msp/user/org1-admin/msp/signcerts/cert.pem $FABRIC_CFG_PATH/orgs/org1/msp/user/org1-admin/msp/admincerts/cert.pem
